...
const Todolist = () => {
  ...
  return (
    <div className="container bg-slate-100">
      ...
      <input className="bg-transparent mt-3 p-2 rounded-lg border outline-none" type="text" placeholder="Add Activity" required value={activity} onChange={(e) => setActivity(e.target.value)} />
      <button className="text-white font-semibold bg-green-400 p-2 rounded-lg ml-2 w-20" onClick={addActivity}>Add</button>
        ...
        return (
          <div key={i} >
            <div className="flex gap-3 items-center justify-between px-6 py-1 text-white  bg-gray-500 mt-2">
              ...
              <button className="bg-red-400 p-1 font-normal rounded-md hover:bg-red-500" onClick={() => removeActivity(i)}>remove</button>
              <p>Abdullah</p>
